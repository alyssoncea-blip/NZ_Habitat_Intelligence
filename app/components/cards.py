            ...
            [
                ...
                dbc.CardBody(
                    [
                        ...
                        html.Div(
                            status, className="kpi-status", style={"color": color}
                        ),
        ...
        return dbc.Card(
            [
                dbc.CardHeader(
                    [
                        html.Span(
                            icon, style={"marginRight": "8px", "fontSize": "1.2em"}
                        ),
...
class HeroKPICard:
    ...
    def create(title, value, unit, description, status, color, confidence=None):
        ...
        if description:
            children.append(html.P(description, className="hero-description"))
...
class ExecutiveKPICard:
    ...
    @staticmethod
    def create_pressure_index_card(
        value: float,
        trend: str = "up",
        change: float = 3.2,
        ...
        trend_color = (
            "#28a745" if trend == "up" else "#dc3545" if trend == "down" else "#6c757d"
        )
    ...
    def create_affordability_card(value: float, trend: str = "up", change: float = 0.4):
        ...
        trend_color = (
            "#dc3545" if trend == "up" else "#28a745"
        )  # for affordability, rising is bad
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "Affordability Score (Price/Income)",
                            className="kpi-card-title text-muted mb-2",
                            style={
                                "fontSize": "0.75rem",
                                "textTransform": "uppercase",
            ...
            rows.append(
                html.Div(
                    [
                        ...
                        html.Span(
                            "⚠️" if score >= 80 else "⚡" if score >= 60 else "✓",
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 07 — Median House Price",
                            style=HousingKPICard._title_style(),
                        ),
                        html.P(
                            subtitle,
            ...
            className="housing-kpi-card h-100",
            style=HousingKPICard._card_style(),
        )
        ...
        for prop_type, pct in breakdown.items():
            ...
            bars.append(
                html.Div(
                    [
                        html.Span(
                            labels.get(prop_type, prop_type),
        ...
        segments = [
            html.Div(
                [
                    ...
                    html.Span(
                        format_m2(bedrooms.get("1bed", 8000)),
                        style={
                            "fontSize": "0.72rem",
                            "fontWeight": "600",
                            "marginLeft": "4px",
            ...
            html.Div(
                [
                    ...
                    html.Span(
                        format_m2(bedrooms.get("2bed", 8000)),
                        style={
                            "fontSize": "0.72rem",
                            "fontWeight": "600",
                            "marginLeft": "4px",
            ...
            html.Div(
                [
                    ...
                    html.Span(
                        format_m2(bedrooms.get("3bed", 8000)),
                        style={
                            "fontSize": "0.72rem",
                            "fontWeight": "600",
                            "marginLeft": "4px",
            ...
            html.Div(
                [
                    ...
                    html.Span(
                        format_m2(bedrooms.get("4bed", 8000)),
                        style={
                            "fontSize": "0.72rem",
                            "fontWeight": "600",
                            "marginLeft": "4px",
...
class TourismKPICard:
    ...
    @staticmethod
    def _build_sparkline_bar(
        width: int = 60, height: int = 28, color: str = "#2E86AB"
    ) -> html.Div:
        return html.Div(
            style={
                "display": "flex",
    ...
    @staticmethod
    def _sparkline_bars(
        data: list, width: int = 80, height: int = 28, color: str = "#2E86AB"
    ) -> html.Div:
        if not data:
            return html.Div()
        bars = []
    ...
    def create_pressure_index_card(
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 13 — Tourism Pressure Index",
                            style=TourismKPICard._title_style(),
                        ),
                        html.P(
            ...
            className="housing-kpi-card h-100",
            style=TourismKPICard._card_style(),
        )

    # ── KPI 14: Airbnb Share ────────────────────────────────────────────────
    @staticmethod
    def create_airbnb_share_card(
        value: float,
        unit: str = "%",
        trend: str = "up",
        change: float = 1.8,
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 14 — Airbnb Share of Rentals",
                            style=TourismKPICard._title_style(),
                        ),
                        html.P(
                            "% of Housing Supply Listed on Airbnb",
                            className="text-muted mb-2",
                            style={"fontSize": "0.78rem"},
                        ),
                        html.Div(
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 15 — Tourism → Rent Price Lag",
                            style=TourismKPICard._title_style(),
                        ),
                        html.P(
                            "Lag Effect (Visitors → Rent Increase)",
                            className="text-muted mb-2",
                            style={"fontSize": "0.78rem"},
                        ),
                        html.Div(
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    " → ",
                                    style={"fontSize": "0.65rem", "color": "#dee2e6"},
                                ),
                                html.Span(
                                    f"+{value:.0f}m",
                                    style={
    ...
    @staticmethod
    def create_dom_correlation_card(
        value: float,
        unit: str = "r",
        trend: str = "neutral",
        strength: str = "Strong",
...
class MacroKPICard:
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 18 — OCR Current", style=MacroKPICard._title_style()
                        ),
                        html.P(
            ...
            className="housing-kpi-card h-100",
            style=MacroKPICard._card_style(),
        )
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 19 — Mortgage Rates", style=MacroKPICard._title_style()
                        ),
                        html.P(
                            subtitle,
                            className="text-muted mb-2",
                        ...
                        html.Div(
                            [rate_row(t) for t in terms], style={"padding": "4px 0"}
                        ),
                        html.Hr(style={"margin": "8px 0 6px"}),
                        html.Div(
                            [
    ...
    def create_mortgage_cost_card(
        ...
        sorted_suburbs = sorted(
            (by_suburb or {}).items(), key=lambda x: x[1], reverse=True
        )[:5]
            ...
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 20 — Monthly Mortgage Cost",
                            style=MacroKPICard._title_style(),
                        ),
                        html.P(
                            "$750K loan @ 6.20% (2Y)",
                            className="text-muted mb-1",
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    f" ${abs(change):,} vs prev",
                                    style={"color": trend_color, "fontSize": "0.8rem"},
                                ),
                            ],
                            className="text-center mb-2",
                        ),
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    top_suburb[0] if top_suburb else "N/A",
                                    style={
                                        "fontSize": "0.72rem",
                                        "fontWeight": "600",
                                        "color": accent,
                                ...
                                html.Span(
                                    f" ${top_suburb[1]:,}" if top_suburb else "",
                                    style={
                                        "fontSize": "0.72rem",
                                        "fontWeight": "700",
                                        "color": accent,
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    " MoM",
                                    style={"color": "#8898aa", "fontSize": "0.72rem"},
                                ),
                                html.Span(
                                    " ● ",
                                    style={"color": "#dee2e6", "fontSize": "0.8rem"},
                                ),
                                html.Span(
                                    status,
                                    style={
    ...
    @staticmethod
    def create_ocr_listings_corr_card(
        value: float,
        unit: str = "r",
        strength: str = "Strong",
        type: str = "Negative",
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    " r", style={"fontSize": "1.2rem", "color": accent}
                                ),
                            ],
                            className="d-flex align-items-center justify-content-center mb-1",
                        ),
...
class AffordabilityKPICard:
    ...
    def create_years_to_buy_card(
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 23 — Years to Buy a House",
                            style=AffordabilityKPICard._title_style(),
                        ),
                        html.P(
            ...
            className="housing-kpi-card h-100",
            style=AffordabilityKPICard._card_style(),
        )

    # ── KPI 24: Rent Burden ─────────────────────────────────────────────
    @staticmethod
    def create_rent_burden_card(
        value: float,
        unit: str = "%",
        trend: str = "up",
        change: float = 2.5,
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    " ● ",
                                    style={"color": "#dee2e6", "fontSize": "0.65rem"},
                                ),
                                html.Span(
                                    status,
                                    style={
            ...
            [
                dbc.CardBody(
                    [
                        ...
                        html.P(
                            "National Position (1=Best, 16=Worst)",
                            className="text-muted mb-1",
                            style={"fontSize": "0.78rem"},
                        ),
                        html.Div(
                        ...
                        html.Div(
                            [
                                html.Span(
                                    "of 16 regions",
                                    style={"color": "#8898aa", "fontSize": "0.78rem"},
                                ),
                            ],
                            className="text-center mb-2",
                        ),
                        ...
                        html.Div(
                            [
                                html.Span(
                                    "Best: ",
                                    style={"fontSize": "0.65rem", "color": "#28a745"},
                                ),
                                html.Span(
                                    best_region,
                                    style={
                            ...
                            [
                                html.Div(
                                    [
                                        ...
                                        html.Span(
                                            f"{np.mean(list(by_region_growth.values())):.1f}%",
                                            style={
                                                "fontSize": "0.75rem",
                                                "fontWeight": "700",
                                                "color": "#D35400",
                                ...
                                html.Div(
                                    [
                                        ...
                                        html.Span(
                                            f"{np.mean(list(by_region_supply.values())):.1f}%",
                                            style={
                                                "fontSize": "0.75rem",
                                                "fontWeight": "700",
                                                "color": "#2E86AB",
...
class ForecastKPICard:
    ...
    @staticmethod
    def _sparkline_line(
        data: list, width: int = 100, height: int = 28, color: str = "#2E86AB"
    ) -> html.Div:
        if not data:
            return html.Div()
        bars = []
    ...
    def _range_bar(low: float, high: float, midpoint: float, color: str) -> html.Div:
        ...
        return html.Div(
            [
                ...
                html.Div(
                    style={"flex": str(mid_pct), "height": "8px", "background": color}
                ),
                html.Div(
                    style={
                        "flex": str(high_pct),
    ...
    @staticmethod
    def create_price_forecast_card(
        value: float,
        unit: str = "NZD",
        current: float = 0,
        change_pct: float = 0,
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 28 — 12-Month Price Forecast",
                            style=ForecastKPICard._title_style(),
                        ),
                        html.P(
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    trend_icon,
                                    style={"color": trend_color, "marginLeft": "4px"},
                                ),
                            ],
                            className="text-center mb-2",
                        ),
            ...
            className="housing-kpi-card h-100",
            style=ForecastKPICard._card_style(),
        )

    # ── KPI 29: Confidence Range ─────────────────────────────────────────
    @staticmethod
    def create_confidence_range_card(
        range_80_low: float,
        range_80_high: float,
        range_95_low: float,
        range_95_high: float,
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    " → ",
                                    style={"fontSize": "0.9rem", "color": "#dee2e6"},
                                ),
                                html.Span(
                                    f"${range_80_high:,.0f}",
                                    style={
                        ...
                        html.Div(
                            [
                                html.Span(
                                    f"95%: ${range_95_low:,.0f} – ${range_95_high:,.0f}",
                                    style={"fontSize": "0.65rem", "color": "#8898aa"},
                                ),
                            ],
                            className="text-center",
                ...
                dbc.CardBody(
                    [
                        ...
                        html.Div(
                            [
                                html.Span(
                                    f"OCR {base_ocr:.2f}% → {scenario_ocr:.2f}%",
                                    style={
                                        "fontSize": "0.72rem",
                                        "fontWeight": "600",
                                        "color": accent,
    ...
    @staticmethod
    def create_tourism_impact_card(
        value: float, unit: str = "days", direction: str = "up", scenario_pct: int = 20
    ):
        ...
        return dbc.Card(
            [
                dbc.CardBody(
                    [
                        html.H6(
                            "KPI 31 — Tourism +20% Impact (DOM)",
                            style=ForecastKPICard._title_style(),
                        ),
                        html.P(
                            "Tourism Scenario Effect",
                            className="text-muted mb-1",
                            style={"fontSize": "0.78rem"},
                        ),
                        html.Div(
