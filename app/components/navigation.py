                            ...
                            dbc.Col(
                                [
                                    html.Div(
                                        [
                                            html.Span(
                                                "●", className="status-dot status-live"
                                            ),
                                            html.Span(
                                                "Live Data", className="status-text"
                                            ),
                                        ],
                                        className="status-indicator",
                                    ),
                                    html.Small(
                                        id="last-update-time", className="update-time"
                                    ),
                                ],
                                width="auto",
        ...
        children=[
            html.Div(
                [
                    ...
                    dcc.Link(
                        "Housing Market", href="/housing", className="sidebar-link"
                    ),
                    dcc.Link(
                        "Tourism Impact", href="/tourism", className="sidebar-link"
                    ),
                    dcc.Link("Macroeconomic", href="/macro", className="sidebar-link"),
                    dcc.Link(
                        "Affordability", href="/affordability", className="sidebar-link"
                    ),
                    dcc.Link(
                        "Forecast & Risk", href="/forecast", className="sidebar-link"
                    ),
                ],
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        id="data-quality-indicator", className="quality-indicator"
                    ),
                    html.Button(
                    ...
                    html.Small(
                        "Last checked: Today", className="text-muted d-block mt-2"
                    ),
                ],
                className="sidebar-section",
            ),
...
def create_breadcrumbs(current_page):
    ...
    breadcrumb_items = []
    breadcrumb_items.append(dbc.BreadcrumbItem("Home", href="/"))
            ...
            [
                dbc.CardBody(
                    [
                        ...
                        html.P(
                            dashboard["description"], className="switcher-description"
                        ),
                        html.A(
                            "Open Dashboard",
                            href=dashboard["href"],
