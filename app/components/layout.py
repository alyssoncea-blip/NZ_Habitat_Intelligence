...
def create_section_header(title, subtitle=None):
    ...
    return dbc.Row([dbc.Col(children, width=12)], className="section-header")
...
def create_hero_section(title, kpi_value, kpi_subtitle=None):
    ...
    if kpi_subtitle:
        children.append(html.P(kpi_subtitle, className="hero-subtitle"))

    return dbc.Row(
        [dbc.Col(dbc.Card(dbc.CardBody(children), className="hero-card"), width=12)],
                    ...
                    html.Div(
                        [
                            ...
                            dcc.Dropdown(
                                id="region-selector",
                                options=[
                                    {"label": r, "value": r} for r in region_options
                                ],
                                value="All Regions",
...
def create_loading_spinner(
    component_id: str, children=None, spinner_type: str = "default"
):
