            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.Br(),
                        html.Small(
                            f"Sources: {len(sources)}", className="quality-stat"
                        ),
                    ],
    ...
    if compact:
        ...
        return html.Div(
            [
                ...
                html.Span(
                    f" ({get_quality_description(quality_score)})",
...
def create_data_health_dashboard():
                    ...
                    [
                        dbc.CardHeader(
                            [
                                html.H6(
                                    dashboard.title(),
                                    className="dashboard-health-title",
                                )
                            ]
                        ),
                        dbc.CardBody(
                            [
                                ...
                                html.Div(
                                    [
                                        html.Small(
                                            f"KPIs: {completeness['total_kpis']}",
                                            className="health-stat",
                                        ),
                                        html.Br(),
                                        html.Small(
                                            f"Complete: {completeness['complete_kpis']} ({completeness['completeness_ratio']:.0f}%)",
                                            className="health-stat",
                                        ),
                                    ],
    ...
    return dbc.Container(
        [
            ...
            html.P(
                "Overview of data quality across all dashboards",
                className="health-dashboard-subtitle",
            ),
