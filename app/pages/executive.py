    ...
    return dbc.Container(
        [
            create_section_header(
                "NZ Housing Pulse", "Executive Overview - Real-time Market Intelligence"
            ),
            create_filter_bar(
                        ...
                        [
                            dbc.Col(
                                ExecutiveKPICard.create_pressure_index_card(
                                    ...
                                    sparkline_data=hero_kpis["pressure_index"].get(
                                        "sparkline"
                                    ),
                                ),
                                width=12,
                            ...
                            dbc.Col(
                                ExecutiveKPICard.create_price_mom_card(
                                    ...
                                    sparkline_data=hero_kpis["price_mom"].get(
                                        "sparkline"
                                    ),
                                ),
                                width=12,
                            ...
                            dbc.Col(
                                ExecutiveKPICard.create_ocr_card(
                                    ...
                                    twelve_months_ago=hero_kpis["ocr"][
                                        "twelve_months_ago"
                                    ],
                                    change_bps=hero_kpis["ocr"]["change_bps"],
                                    next_decision=hero_kpis["ocr"].get(
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.P(
                                                "Regional housing market pressure index",
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Graph(
                                                ...
                                                figure=_create_dual_axis_figure(
                                                    data["dual_axis"]
                                                ),
                                                config={"displayModeBar": False},
                                                style={"height": "250px"},
        ...
        fluid=True,
        className="executive-dashboard py-4",
        style={
