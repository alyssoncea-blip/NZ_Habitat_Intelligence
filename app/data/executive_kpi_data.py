...
REGION_COORDS = {
    "Northland": (-35.58, 174.07), "Auckland": (-36.85, 174.76),
    "Waikato": (-37.78, 175.28), "Bay of Plenty": (-37.92, 176.88),
    "Gisborne": (-38.66, 177.98), "Hawke's Bay": (-39.49, 176.92),
    "Taranaki": (-39.29, 174.17), "Manawatu-Wanganui": (-39.93, 175.66),
    "Wellington": (-41.29, 174.77), "Tasman": (-41.50, 172.80),
    "Nelson": (-41.27, 173.28), "Marlborough": (-41.50, 173.96),
    "West Coast": (-42.60, 171.40), "Canterbury": (-43.53, 172.63),
    "Otago": (-45.87, 170.50), "Southland": (-46.40, 168.35),
}

MAIN_CITIES = {
    "Queenstown": (-45.03, 168.66), "Tauranga": (-37.69, 176.17),
    "Rotorua": (-38.14, 176.25), "Napier": (-39.49, 176.92),
    "Hamilton": (-37.79, 175.28), "Dunedin": (-45.87, 170.50),
...
_REGION_PRICE = {
    "Auckland": 1050000, "Wellington": 780000, "Christchurch": 610000,
    "Hamilton": 720000, "Dunedin": 560000, "Tauranga": 710000,
    "Queenstown": 950000, "Rotorua": 480000, "Napier": 560000,
    "Nelson": 630000, "Northland": 620000, "Waikato": 720000,
    "Bay of Plenty": 710000, "Gisborne": 480000, "Hawke's Bay": 560000,
    "Taranaki": 490000, "Manawatu-Wanganui": 440000, "Tasman": 640000,
    "Marlborough": 590000, "West Coast": 380000, "Canterbury": 610000,
    "Otago": 560000, "Southland": 420000,
}
_REGION_INCOME = {
    "Auckland": 78000, "Wellington": 75000, "Christchurch": 69000,
    "Hamilton": 68000, "Dunedin": 63000, "Tauranga": 65000,
    "Queenstown": 72000, "Rotorua": 56000, "Napier": 63000,
    "Nelson": 62000, "Northland": 62000, "Waikato": 68000,
    "Bay of Plenty": 65000, "Gisborne": 56000, "Hawke's Bay": 63000,
    "Taranaki": 67000, "Manawatu-Wanganui": 60000, "Tasman": 64000,
    "Marlborough": 61000, "West Coast": 55000, "Canterbury": 69000,
    "Otago": 63000, "Southland": 58000,
}
...
def _pressure_for_region(region: str) -> float:
    ...
    ratio = _REGION_PRICE.get(region, 600000) / max(1, _REGION_INCOME.get(region, 60000))
...
def load_executive_data() -> Dict[str, Any]:
    ...
    pressure_val = float(habitat_score.get("value", 63.3)) if isinstance(habitat_score, dict) else 63.3
    ...
    for r in NZ_REGIONS_LIST:
        ...
        regions_for_map.append({
            "region": r, "pressure": pressure_values.get(r, 50),
    ...
    pressure_sparkline = _get_silver_timeseries("supply_deficit", "supply_deficit_score", 12)

    price_mom_sparkline = _get_silver_timeseries("rent_income_ratio", "rent_inflation_rate", 12)

    hero_kpis = {
        "pressure_index": {
            "id": "pressure_index", "label": "Composite Housing Pressure Index",
            "value": pressure_val, "unit": "pts", "trend": "up",
            "change": gdp_val, "change_unit": "% vs last year",
            "sparkline": pressure_sparkline,
            "regions": pressure_values,
        },
        "affordability": {
            "id": "affordability", "label": "Affordability Score (Price/Income)",
            "value": round(np.mean(list(affordability_values.values())), 1),
            "unit": "x", "trend": "up", "change": 0.4, "change_unit": "vs last year",
            "thresholds": {"good": 5, "warning": 8, "bad": 12},
            "regions": affordability_values,
        },
        "price_mom": {
            "id": "price_mom", "label": "Asking Price MoM Change",
            "value": round(np.mean(list(price_mom_values.values())), 1),
            "unit": "%", "trend": "up", "change": 0.2, "change_unit": "pp vs last month",
            "sparkline": price_mom_sparkline,
            "regions": price_mom_values,
        },
        "ocr": {
            "id": "ocr", "label": "OCR Current vs 12 Months Ago",
            "current": ocr_val, "twelve_months_ago": round(ocr_val - 0.25, 2),
            "change_bps": 25, "unit": "%", "trend": "up",
            "next_decision": "2026-05-28",
        },
        "top3": {"id": "top3", "label": "Top 3 Regions Under Pressure", "top3": top3, "trend": "up"},
        "map_preview": {"id": "map_preview", "label": "Regional Pressure Map", "regions": regions_for_map},
    }
    ...
    rent_inflation_ts = _get_silver_timeseries("rent_income_ratio", "rent_inflation_rate", 12)
    ...
    return {
        ...
        "dual_axis": {"months": line_months, "ocr": ocr_vals, "pressure": pressure_vals,
                       "ocr_unit": "%", "pressure_unit": "pts"},
        "regions": NZ_REGIONS,
        "region_coords": REGION_COORDS,
    }


__all__ = ['load_executive_data', 'NZ_REGIONS_LIST', 'REGION_COORDINATES', 'NZ_REGIONS', 'REGION_COORDS']
