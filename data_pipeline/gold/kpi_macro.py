        ...
        rows = [
            {
                ...
                "value": round(ocr, 2),
                "unit": "%",
                "description": "Reserve Bank Official Cash Rate (latest)",
                "category": "Macro",
                "source": "RBNZ OCR",
            },
            {
                "name": "OCR vs 10y Average",
                "value": round(ocr - 3.44, 2),
                "unit": "%",
                "description": "Current OCR vs 3.44% 10-year average",
                "category": "Macro",
                "source": "RBNZ historical OCR",
            },
            {
                "name": "Mortgage Rate 1Y Fixed",
                "value": mortgage_1y,
                "unit": "%",
                "description": "Estimated 1-year fixed mortgage rate",
                "category": "Macro",
                "source": "OCR + market spread",
            },
            {
                "name": "Mortgage Rate 2Y Fixed",
                "value": mortgage_2y,
                "unit": "%",
                "description": "Estimated 2-year fixed mortgage rate",
                "category": "Macro",
                "source": "OCR + market spread",
            },
            {
                "name": "Mortgage Rate 5Y Fixed",
                "value": mortgage_5y,
                "unit": "%",
                "description": "Estimated 5-year fixed mortgage rate",
                "category": "Macro",
                "source": "OCR + market spread",
            },
            {
                "name": "Monthly Mortgage Cost ($750k)",
                "value": float(monthly_cost),
                "unit": "NZD/month",
                "description": "Monthly payment on $750k loan at 2Y rate, 30yr",
                "category": "Macro",
                "source": "Mortgage rate calculation",
            },
            {
                "name": "Construction Employment",
                "value": construction_emp,
                "unit": "%",
                "description": "Construction sector employment proxy",
                "category": "Macro",
                "source": "Stats NZ unemployment inverse",
            },
            {
                "name": "OCR x Listings Correlation",
                "value": ocr_listings_corr,
                "unit": "r",
                "description": "Correlation between OCR and listing volume",
                "category": "Macro",
            ...
            },
            {
                ...
                "unit": "%",
                "description": "GDP per capita year-over-year growth",
                "category": "Macro",
